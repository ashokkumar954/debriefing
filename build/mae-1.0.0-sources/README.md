...
MAE uses two OFSC application keys configured on the *Configuration > Forms & Plugins > Applications* screen:
...
**3. Properties** — Ensure `problem_code` is added to the plugin's Available Properties with at least **Read** access. This is how MAE receives the list of asset types for the activity.

**4. Screen button** — Using *Configuration > User Types > Screen Configuration*, add the MAE button to the "Edit/View activity" screen for all relevant user types.


## Development

MAE is an [Oracle JET](https://www.oracle.com/webfolder/technetwork/jet/index.html) web application. It uses the [OFS Plugin API](https://docs.oracle.com/en/cloud/saas/field-service/19b/fapcf/toc.htm) to communicate with OFSC.
